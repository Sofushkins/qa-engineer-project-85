...
Этот репозиторий содержит тестовую документацию, созданную в рамках ручного тестирования сайта [[https://products-store-ru.hexlet.app](https://codebattle.hexlet.io/)]. Проект выполнен как часть учебной программы.

Объект тестирования

    Сайт: [Hexlet Codebattle]
    URL: [[https://products-store-ru.hexlet.app](https://codebattle.hexlet.io/)]
